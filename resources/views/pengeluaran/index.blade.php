        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <button class="btn btn-success btn-xs" onclick="addForm('{{ route('pengeluaran.store') }}')">
        ...
        function editForm(url) {
            ...
            $.get(url)
                .done((response) => {
                    ...
                    $('#modal-form [name=nama_pengeluaran]').val(response.nama_pengeluaran);
                    $('#modal-form [name=tipe_pengeluaran]').val(response.tipe_pengeluaran);
                })
                .fail((errors) => {
