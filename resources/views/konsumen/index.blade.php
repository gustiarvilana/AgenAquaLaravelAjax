        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <button class="btn btn-success btn-xs" onclick="addForm('{{ route('konsumen.store') }}')">
...
@push('js')
    <script>
        ...
        function editForm(url) {
            ...
            $.get(url)
                .done((response) => {
                    ...
                    $('#modal-form [name=id_kelurahan]').val(response.id_kelurahan);
                    $('#modal-form [name=id_kecamatan]').val(response.id_kecamatan);
                    $('#modal-form [name=id_kota]').val(response.id_kota);
                    $('#modal-form [name=tipe_pelanggan]').val(response.tipe_pelanggan);
                })
                .fail((errors) => {
        ...
        function deleteData(url) {
            if (confirm('Yakin akan menghapus konsumen terpilih?')) {
                $.post(url, {
